...
class TestMemory(unittest.TestCase):
    ...
    def test_remove_memory_children(self):
        ...
        memory.remove_dead_memories(memory.CHILD_MEM, children, forgot, el1[memory.ID])
    ...
    def test_get_valid_child_memory_empty(self):
        ...
        memories = memory.get_live_memories(el1, memory.CHILD_MEM)
        self.assertEqual(0, len(memories))
    ...
    def test_get_valid_child_memory_success(self):
        ...
        child_memories1 = memory.get_live_memories(el3, memory.CHILD_MEM)
        self.assertEqual(2, len(child_memories1))

        el4 = self.database.add_memory({memory.CHILD_MEM: [el1[memory.ID], el2[memory.ID], 9]})
        child_memories2 = memory.get_live_memories(el4, memory.CHILD_MEM)
        ...
        child_memories3 = memory.get_live_memories(el5, memory.CHILD_MEM)
        ...
        memory.get_live_memories(el6, memory.CHILD_MEM)
