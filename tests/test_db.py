...
class TestDB(unittest.TestCase):
    ...
    def test_add_memory(self):
        ...
        query = Query()
        record = self.database.table.search(query.type == memory.MEMORY)[0]
        self.assertEqual(record[memory.TYPE], memory.MEMORY)
    ...
    def test_add_vision(self):
        ...
        query = Query()
        record = self.database.table.search(query.type == memory.VISION)[0]
    ...
    def test_add_sound(self):
        ...
        query = Query()
        record = self.database.table.search(query.type == memory.SOUND)[0]
    ...
    def test_add_focus(self):
        ...
        query = Query()
        record = self.database.table.search(query.type == memory.FOCUS)[0]
    ...
    def test_add_speak(self):
        ...
        query = Query()
        record = self.database.table.search(query.type == memory.SPEAK)[0]
