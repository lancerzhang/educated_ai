...
docId1 = table.insert(
    {'strength': 100, 'type': 'memory', 'recall': 1, 'reward': 1, 'lastRecall': 20180106, 'children': [123, 123]})
docId2 = table.insert(
    {'strength': 100, 'type': 'vision', 'recall': 1, 'reward': 1, 'lastRecall': 20180106, 'filter': 'vf1',
     'data': 'abc'})
table.insert({'strength': 99, 'type': 'sound', 'recall': 1, 'reward': 1, 'lastRecall': 20180106, 'data': '123'})
table.insert(
    {'strength': 99, 'type': 'move_vision', 'recall': 1, 'reward': 1, 'lastRecall': 20180106, 'angle': 10, 'speed': 10,
     'duration': 10})
